  ...
  <div class="order-content">
    ...
    <el-card shadow="hover">
      <el-form :inline="true" size="small" :model="searchFrom" class>
        ...
        <el-form-item label="评论状态:">
          <el-select v-model="searchFrom.commentStatus" filterable placeholder="请选择">
    ...
    <el-card style="margin-top:25px;">
      ...
      <el-table :data="tableData" stripe style="width: 100%">
        ...
        <el-table-column prop="comment" label="评论" width="300" />
...
export default {
  ...
  methods: {
    ...
    pageGetCommentFun (e) {
      ...
      pageGetComment("mini/pageGetComment", data)
        .then(res => {
          closeLoading();
          if (res.data.data) {
    ...
    queryCommentFun (searchFrom) {
      let _this = this;
      startLoading();
      queryComment("mini/queryComment", searchFrom)
        .then(res => {
          closeLoading();
          if (res.data.data) {
            _this.tableData = res.data.data;
    ...
    changeCommentStatusFun (data) {
      let _this = this;
      startLoading();
      changeCommentStatus("mini/changeCommentStatus", data)
        .then(res => {
          closeLoading();
          if (res.data.data) {
